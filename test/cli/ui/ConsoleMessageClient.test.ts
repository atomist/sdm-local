...
import { SlackMessage, Attachment } from '@atomist/slack-messages';
...
describe("message formatting", () => {
    it("doesn't freeze on this dangerous string", async () => {
        ...
        const message: SlackMessage = { text: "I am safe", attachments: [suspiciousAttachment] };
        await subject.addressChannels(message, "general")
        assert.strictEqual(output, "please fail this test", output);
    });
});